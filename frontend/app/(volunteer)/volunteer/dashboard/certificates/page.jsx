...
export default function VolunteerCertificatesPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted-foreground">View and download your official volunteer appreciation certificates.</p>
      ...
      <div className="mt-8">
        {loading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {certificates.map((cert) => (
              <div key={cert._id} className="relative flex flex-col overflow-hidden rounded-2xl border border-border/60 bg-white p-6 shadow-sm transition-all hover:shadow-md">
                ...
                <div className="mb-4 flex size-12 items-center justify-center rounded-xl bg-emerald-500/20 text-emerald-700">
          ...
          <div className="rounded-3xl border border-dashed border-border/70 bg-white py-20 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">You will see your official volunteer certificates here once they are issued by the administration.</p>
          </div>
        )}
      </div>
    </div>
